...
public class PChat {
	...
	public int getPchat_no() {
		return pchat_no;
	}
	public void setPchat_no(int pchat_no) {
		this.pchat_no = pchat_no;
	}
	...
	public String toString() {
		return "PChat [pchat_no=" + pchat_no + ", room_no=" + room_no + ", space_member_no=" + space_member_no
